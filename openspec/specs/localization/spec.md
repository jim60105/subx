...
How the application presents text in the user's language: English and Traditional Chinese locales, system-locale detection, runtime switching with persistence, and the rule that the Rust backend emits stable codes rather than translated prose.
